          ...
          <div className="overflow-hidden">
            <table className="min-w-full text-left text-sm font-light">
              ...
              <thead className="border-b font-medium dark:border-neutral-500">
                <tr>
                  <th scope="col" className="px-6 py-4">Keycode</th>
                  <th scope="col" className="px-6 py-4">Modifiers</th>
              ...
              <tbody>
                {
                  config.activeScenario.KeymapItems.map((item, _) => (
                    <tr
                      ...
                      <td className="whitespace-nowrap px-6 py-4 font-medium">{item.keycode}</td>
                      <td className="whitespace-nowrap px-6 py-4">{item.modifiers}</td>
