...
export const ConfigContext: React.Context<ConfigContextType> =
...
export default function App(): JSX.Element {
    ...
    const [activeKeyboardConfigName, setActiveKeyboardConfigName] = useState(
        defaultConfig.name
    )
        ...
        <ConfigContext.Provider value={value}>
            <div className="flex flex-row h-screen">
                ...
                <div className="w-full md:w-10/12 flex flex-col items-center p-4">
                    ...
                    >
                        Create a PR to share your keybindings | 提交一个 PR
                        来分享你的快捷键
                    </a>
