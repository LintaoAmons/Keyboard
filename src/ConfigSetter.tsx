...
export default function ConfigSetter(): JSX.Element {
    ...
    const [currentConfigJsonString, setCurrentConfigJsonString] = useState(
        JSON.stringify(configJsons[0])
    )
    ...
    const scenarioOptions = configs
        .filter((it) => it.name === activeKeyboardConfigName)
    ...
    return (
        <div className="flex flex-col px-3 md:h-screen w-full md:w-3/12">
            ...
            <div className="md:flex-col flex">
                <label
                    htmlFor="profiles"
                    className="flex w-full items-baseline mx-3"
                >
            ...
            <div className="flex justify-between mb-2 ml-2" role="group">
                ...
                <h2 className="md:hidden text-rose-700">
                    Rotate your phone to get better view
                </h2>
                <h2 className="md:hidden text-rose-700">
                    横屏获得更好效果(作者太菜)
                </h2>
